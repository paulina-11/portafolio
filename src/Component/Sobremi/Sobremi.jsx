  ...
  return (
    <div>
      ...
      >
        ...
        <div>
          <p className="text-orange-100 text-justify p-10 text-xl indent-12">
            Soy un entusiasta de la tecnología y del aprendizaje autodidacta. Mis habilidades técnicas en programación y desarrollo web, adquiridas en el último año, se complementan con mi sentido de responsabilidad, capacidad organizativa y habilidades de comunicación efectivas. Mi especialización radica en la creación de interfaces interactivas y visualmente atractivas, y siempre estoy en la búsqueda activa de oportunidades para expandir mis conocimientos y habilidades.
          </p>
